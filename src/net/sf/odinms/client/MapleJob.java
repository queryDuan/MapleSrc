...
public enum MapleJob {
    ...
    public String getJobNameAsString() {
        ...
        if (job == BEGINNER) {
            ...
            return "战神二转";
                    } if (job == GHOST_KNIGHT_2) {
            return "魂骑士";
                    } if (job == FIRE_KNIGHT_2) {
            return "炎术士";
                    } if (job == WIND_KNIGHT_2) {
            return "风灵使者";
                    } if (job == NIGHT_KNIGHT_2) {
            return "夜行者";
                    } if (job == THIEF_KNIGHT_2) {
            return "奇袭者";
                    } if (job == Ares_3){
            return "战神三转";
                    } if (job == GHOST_KNIGHT_3) {
            return "魂骑士";
                    } if (job == FIRE_KNIGHT_3) {
            return "炎术士";
                    } if (job == WIND_KNIGHT_3) {
            return "风灵使者";
                    } if (job == NIGHT_KNIGHT_3) {
            return "夜行者";
                    } if (job == THIEF_KNIGHT_3) {
            return "奇袭者";
                    } if (job == Ares_4){
            return "战神四转";
        } else if (job == THIEF) {
