        ...
        try {
            switch (itemType) {
                ...
                case 507: { //smegas
                    ...
                    String laba = "[第" + player.getlaba() + "次喇叭]";
                    String prefix = "";
           ...
           if (itemId == 5390006) {
           if ((c.getPlayer().getzb() >= 2) && (player.getVip() >= 2)) {
            // c.getPlayer().setzb(-2);
             ok = true;
           } else {
              ok = true;
             //str = "2元宝 此喇叭限制了vip2以上才能使用";
          }
          } else if ((c.getPlayer().getzb() >= 1)) {
            ...
            if (ok) {
                   ...
                   switch (itemId / 1000 % 10) { 
                       ...
                       case 1: 
                           ...
                           NPCScriptManager.getInstance().start(c, 1002005); //仓库
                           break; 
                   } 
                   MapleInventoryManipulator.removeFromSlot(c, MapleInventoryType.CASH, slot, (short) 1, false); 
                   break; 
